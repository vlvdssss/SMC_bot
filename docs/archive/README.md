...
- � [Мониторинг и уведомления](docs/MONITORING.md)- 📢 [Настройка Telegram](docs/TELEGRAM_SETUP.md)- �🐛 [История изменений](docs/BUGFIXES.md)
- 🧪 [Тестирование](docs/TESTING_GUIDE.md)
- 🚀 [CI/CD и конфигурация](docs/CI_CD.md)
